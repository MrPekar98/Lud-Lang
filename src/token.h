...
enum token_t {LPARAN_T, RPARAN_T, LBRACE_T, RBRACE_T, IMPORT_T, ID_T, PROTOCOL_T, CLASS_T, INHERITS, RBRACKET_T, LBRACKET_T, IMPLEMENTS, COLON_T, SEMICOLON_T, 
                ...
                ELSE_T, FOR_T, WHILE_T, FOREACH_T, CONSTRUCTOR_T, DESTRUCTOR_T, RETURN_T, NOT_T, BREAK_T, CONTINUE_T, LITERAL_T, DATATYPE_T, ABSTRACT_T, VOLATILE_T, NAMESPACE_T};

// Specifies a node type.
enum rule {START, VARABLE, IMPORTS, PROGRAM, PROTOCOLDECL, CLASSDECL, STATEMENTS, CLASSPROTSTATEMENTS, STATEMENT, SYSTEMCALL, VARDECL, ACCESSORS, DATATYPES, LITERALS, ASSIGNMENT, 
                ...
                IFSTATEMENT, ELSE, FOR_EACH, WHILELOOP, FORLOOP, METHODDECL, CONSTRUCTOR, DESTRUCTOR, CALL, NAMESPACE, MEMBERS, THROW, EXCEPTIONHANDLER};
